...
export function ReportSection({ website1, website2, onRerun, webhookData }: ReportSectionProps) {
  ...
  return (
    <div className="bg-card">
      {/* Tab Bar */}
      <div className="flex items-end justify-between border-b border-border px-8 pt-6 pb-0 no-print">
        ...
        <div className="pb-3">
          {activeTab === "executive" ? (
            <Button
              ...
              variant="outline"
              className="flex items-center gap-2 border-border text-foreground hover:bg-secondary hover:text-foreground no-print"
            >
      ...
      <div className="border-t border-border bg-secondary px-8 py-8 no-print">
